            ...
            VStack(alignment: .leading){
                    ...
                    ScrollView (.horizontal) {
                                    HStack (spacing: 20) {
                                        ...
                                        .background(Color(hue: 1.0, saturation: 0.0, brightness: 0.765, opacity: 0.352))
                                        .cornerRadius(30)
                                        ...
                                        VStack {
                                            Image("famJob")
                                                ...
                                                .aspectRatio(contentMode: .fill)
                                            VStack(alignment: .leading){
                                                Text("Pasteur Job Lorminé et sa famille")
                                                    .font(.system(size: 20, weight: .bold, design: .serif))
                                                    .padding(.horizontal, 10)
                                        ...
                                        VStack {
                                            Image("louange")
                                                ...
                                                .aspectRatio(contentMode: .fill)
                                            VStack(alignment: .leading){
                                                Text("Le groupe de louange de l’EBBSC")
                                                    .font(.system(size: 20, weight: .bold, design: .serif))
                                                    .padding(.horizontal, 10)
